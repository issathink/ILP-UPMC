...
public class InterpreterAMoinsQueTest {
	...
	public InterpreterAMoinsQueTest() {
	...
	public void processFile() throws Throwable { // Ouvre le fichier XML,
		...
		System.out.println("classe " + parser.getClass());
		...
		InterpreterAMoinsQue interpreter = new InterpreterAMoinsQue(gve, oe);
