...
import com.paracamplus.ilp2.tme5.IParserFactory;
import com.paracamplus.ilp2.tme5.Parser;
import com.paracamplus.ilp2.tme5.ParserFactory;
...
public class InterpreterTest extends
	...
	public void processFile() throws Throwable {
		...
		try {
			...
			System.out
					.println("Stop doing shit man with your break IMMA BREAK YOUR LEGS MOTHAFUCKA : "
							+ e.getMessage());
		}
	}
